 ...
 * Generated at: 2019-10-11 06:39:22 UTC
...
ArrayList<String> likeBoList = (ArrayList<String>)request.getAttribute("likeBoList");
	...
	ArrayList<Notification> list=(ArrayList<Notification>)request.getAttribute("list");
      ...
      out.write("\t\t\t\t\t<a class=\"job-listings-featured\" href=\"#\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t");
										...
										for(int i=0; i<likeBoList.size(); i++){ 
											
											if(Integer.parseInt(likeBoList.get(i)) == n.getNoti_no()){ 
												flag = true;												
											}
										}
...
if(!flag){ 
	...
	for(Notification n:list){
      ...
      out.write("\t\t\r\n");
      out.write("\t\tvar likeNo = $(\".likeimg\").click(function (){\r\n");
      out.write("\t\t\t\r\n");
